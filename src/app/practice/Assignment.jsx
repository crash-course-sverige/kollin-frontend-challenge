...
export function Assignment() {
    ...
    return (
        <div className="relative min-w-[80%] flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
            ...
            active:bg-opacity-80 active:text-blue-gray-900 border-solid border-2 border-[#E7E5E4]"
                        >
                            <Radio
                                key={nanoid()}
                                value={option.text}
